...
namespace Tiles
{
    ...
    public class TileSpawner : MonoBehaviour
    {
        ...
        {
            [Tooltip("The tile type to match")]
        ...
        private void RespawnAllTiles()
        {
            ...
            foreach (Vector3Int gridPosition in _tilemap.cellBounds.allPositionsWithin)
            {
        ...
        private void OnTilemapChanged(Tilemap tilemap, Tilemap.SyncTile[] changedTiles)
        {
            ...
            {
                Vector3Int gridPosition = syncTile.position;
        ...
        private void SpawnObjectsAtPosition(Vector3Int gridPosition)
        {
            ...
            foreach (var prefab in prefabList)
            {
                ...
                GameObject instance = Instantiate(prefab, worldPosition, Quaternion.identity, _tilemap.transform);
            ...
            {
                _spawnedObjectsByPosition[gridPosition] = spawnedObjects;
            }
        }
