...
namespace Player
{
    public class Grab : MonoBehaviour, IInputListener
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Handles.Label(transform.position + Vector3.up * grabRange, $"Grab Range: {grabRange:F2}");
            ...
            if (_closestGrabbable != null)
            {
                ...
                Handles.Label(_closestGrabbable.transform.position, "Closest Grabbable");
            }
            ...
            if (_closestInteract != null)
            {
                ...
                Handles.Label(_closestInteract.Transform.position, "Closest Interact");
            }
            ...
            foreach (var rb in _grabbedObjects)
                if (rb != null)
                {
                    ...
                    Handles.Label(rb.transform.position, "GRABBED");
                }
#endif
        }
        ...
        private void ReleaseObj()
        {
            ...
            var rb = _grabbedObjects[_grabbedObjects.Count - 1];
        ...
        private readonly List<Rigidbody2D> _grabbedObjects = new();
