...
namespace Player
{
    ...
    public class PlayerMovement : MonoBehaviour, IInputListener
    {
        ...
        private void Start()
        {
            ...
            if (groundCheck == null)
            {
                ...
                if (groundCheckComponent != null)
                {
                    ...
                    UnityEngine.Debug.Log("GroundCheck auto-assigned from child component: " + groundCheck.name);
                }
            }
            ...
            if (inputManager != null)
            {
                ...
                UnityEngine.Debug.Log("PlayerMovement registered with InputManager");
            }
            else
            {
                UnityEngine.Debug.LogError("InputManager not found! PlayerMovement will not receive input events.");
            }
            ...
            if (visualRoot != null) _initialVisualLocalPos = visualRoot.localPosition;
        }
        ...
        private void GroundCheck()
        {
            ...
            var hitCount =
                Physics2D.OverlapBoxNonAlloc(checkPos, groundCheckSize, 0f, _groundCheckResults, groundLayer);
        ...
        [Header("Visual Sway")] [SerializeField]
