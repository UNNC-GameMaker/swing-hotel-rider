...
namespace GravityTilt
{
    public class Gravity : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Handles.Label(origin + direction + Vector3.up * 0.5f,
            ...
            foreach (var tiltable in Tiltable.AllTiltables)
                ...
                {
                    var pos = tiltable.transform.position;
        ...
        {
            var right = new Vector3(-direction.y, direction.x, 0) * size;
            var left = new Vector3(direction.y, -direction.x, 0) * size;
