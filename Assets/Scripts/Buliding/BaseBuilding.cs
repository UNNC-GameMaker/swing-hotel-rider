...
public class BaseBuilding : MonoBehaviour
{
    ...
    {
        position = new Vector2Int(Mathf.RoundToInt(transform.position.x/_gridManager.BuildableSize.x), Mathf.RoundToInt(transform.position.y/_gridManager.BuildableSize.y));
    }
    ...
    IEnumerator ToPosition(Vector2Int pos, float duration = 1)
    {
        float timer = 0;
